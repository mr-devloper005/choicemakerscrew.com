...
const variantShells = {
  'listing-directory': 'bg-background text-foreground',
  'listing-showcase': 'bg-background text-foreground',
  'article-editorial': 'bg-background text-foreground',
  'article-journal': 'bg-background text-foreground',
  ...
  'profile-business': 'bg-background text-foreground',
  'classified-bulletin': 'bg-background text-foreground',
  'classified-market': 'bg-background text-foreground',
  'sbm-curation': 'bg-background text-foreground',
  'sbm-library': 'bg-background text-foreground',
} as const
...
export async function TaskListPage({ task, category }: { task: TaskKey; category?: string }) {
  ...
  const ui = {
    ...
    panel: 'border border-white/10 bg-card',
    soft: 'border border-white/10 bg-white/5',
    input: 'border border-white/12 bg-input text-foreground',
    button: 'bg-[rgb(232,168,50)] text-[oklch(0.115_0.022_265)] hover:bg-[rgb(245,185,68)]',
  }
